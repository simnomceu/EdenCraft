...
ifeq ($(config),debug_win32)
  ...
  TARGET = $(TARGETDIR)/Argumentalization.exe
  OBJDIR = obj/Win32/Debug/Argumentalization
  DEFINES +=
  INCLUDES += -I../extlibs/include -I../include/utility -I../include/core -I../examples/argumentalization
  FORCE_INCLUDE +=
...
ifeq ($(config),debug_win64)
  ...
  TARGET = $(TARGETDIR)/Argumentalization.exe
  OBJDIR = obj/Win64/Debug/Argumentalization
  DEFINES +=
  INCLUDES += -I../extlibs/include -I../include/utility -I../include/core -I../examples/argumentalization
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),debug_unix32)
  ...
  TARGET = $(TARGETDIR)/Argumentalization
  OBJDIR = obj/Unix32/Debug/Argumentalization
  DEFINES +=
  INCLUDES += -I../extlibs/include -I../include/utility -I../include/core -I../examples/argumentalization
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),debug_unix64)
  ...
  TARGET = $(TARGETDIR)/Argumentalization
  OBJDIR = obj/Unix64/Debug/Argumentalization
  DEFINES +=
  INCLUDES += -I../extlibs/include -I../include/utility -I../include/core -I../examples/argumentalization
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),debug_osx)
  ...
  TARGET = $(TARGETDIR)/Argumentalization
  OBJDIR = obj/OSX/Debug/Argumentalization
  DEFINES +=
  INCLUDES += -I../extlibs/include -I../include/utility -I../include/core -I../examples/argumentalization
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),release_win32)
  ...
  TARGET = $(TARGETDIR)/Argumentalization.exe
  OBJDIR = obj/Win32/Release/Argumentalization
  DEFINES +=
  INCLUDES += -I../extlibs/include -I../include/utility -I../include/core -I../examples/argumentalization
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),release_win64)
  ...
  TARGET = $(TARGETDIR)/Argumentalization.exe
  OBJDIR = obj/Win64/Release/Argumentalization
  DEFINES +=
  INCLUDES += -I../extlibs/include -I../include/utility -I../include/core -I../examples/argumentalization
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),release_unix32)
  ...
  TARGET = $(TARGETDIR)/Argumentalization
  OBJDIR = obj/Unix32/Release/Argumentalization
  DEFINES +=
  INCLUDES += -I../extlibs/include -I../include/utility -I../include/core -I../examples/argumentalization
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),release_unix64)
  ...
  TARGET = $(TARGETDIR)/Argumentalization
  OBJDIR = obj/Unix64/Release/Argumentalization
  DEFINES +=
  INCLUDES += -I../extlibs/include -I../include/utility -I../include/core -I../examples/argumentalization
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),release_osx)
  ...
  TARGET = $(TARGETDIR)/Argumentalization
  OBJDIR = obj/OSX/Release/Argumentalization
  DEFINES +=
  INCLUDES += -I../extlibs/include -I../include/utility -I../include/core -I../examples/argumentalization
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
$(TARGET): $(GCH) ${CUSTOMFILES} $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking Argumentalization
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning Argumentalization
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/main.o: ../examples/argumentalization/main.cpp
	@echo $(notdir $<)
