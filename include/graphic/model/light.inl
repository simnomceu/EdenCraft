...
namespace ece
{
	namespace graphic
	{
		namespace model
		{
			inline void Light::setAmbient(const float ambient) { this->_ambient = ambient; }

			inline void Light::setDiffuse(const float diffuse) { this->_diffuse = diffuse; }

			inline void Light::setSpecular(const float specular) { this->_specular = specular; }
