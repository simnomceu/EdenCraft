	...
	namespace renderer
	{
		...
		namespace opengl
		{
			...
			namespace OpenGL
			{
				...
				static inline void texStorage1D(TargetTexture1D target, std::size_t levels, PixelInternalFormat internalformat, std::size_t width);
				static inline void texStorage2D(TargetTexture2D target, std::size_t levels, PixelInternalFormat internalformat, std::size_t width, std::size_t height);
				static inline void texStorage3D(TargetTexture3D target, std::size_t levels, PixelInternalFormat internalformat, std::size_t width, std::size_t height, std::size_t depth);
				...
				static inline void drawArraysInstancedBaseInstance(PrimitiveMode mode, int first, std::size_t count, std::size_t primcount, unsigned int baseinstance);
				static inline void drawElementsInstancedBaseInstance(PrimitiveMode mode, std::size_t count, const std::vector<std::size_t> & indices, std::size_t primcount, unsigned int baseinstance);
				static inline void drawElementsInstancedBaseVertexBaseInstance(PrimitiveMode mode, std::size_t count, std::vector<std::size_t> & indices, std::size_t primcount, int basevertex, unsigned int baseinstance);
				static inline void drawTransformFeedbackInstanced(PrimitiveMode mode, Handle id, std::size_t primcount);
				static inline void drawTransformFeedbackStreamInstanced(PrimitiveMode mode, Handle id, Handle stream, std::size_t primcount);
				...
				template <class T> static inline void clearBufferSubData(BufferType target, PixelInternalFormat internalformat, int offset, std::size_t size, PixelFormat format, DataType type, const std::vector<T> & data);
				...
				static inline void invalidateBufferSubData(Handle buffer, int offset, std::size_t length);
				...
				static inline void texBufferRange(PixelInternalFormat internalFormat, Handle buffer, int offset, std::size_t size);
				...
				static inline void texStorage2DMultisample(TargetTextureMultisample target, std::size_t samples, PixelInternalFormat internalformat, std::size_t width, std::size_t height, bool fixedsamplelocations);
				static inline void texStorage3DMultisample(TargetTextureMultisample target, std::size_t samples, PixelInternalFormat internalformat, std::size_t width, std::size_t height, std::size_t depth, bool fixedsamplelocations);
				static inline void invalidateTexSubImage(Handle texture, int level, int xoffset, int yoffset, int zoffset, std::size_t width, std::size_t height, std::size_t depth);
				...
				static inline void multiDrawArraysIndirect(PrimitiveMode mode, const std::vector<DrawArraysIndirectCommand> & indirect, std::size_t drawcount, std::size_t stride);
				static inline void multiDrawArraysIndirectCount(PrimitiveMode mode, const std::vector<DrawArraysIndirectCommand> & indirect, int drawcount, std::size_t maxdrawcount, std::size_t stride);
				static inline void multiDrawElementsIndirect(PrimitiveMode mode, DataType type, const std::vector<DrawElementsIndirectCommand> & indirect, std::size_t drawcount, std::size_t stride);
				static inline void multiDrawElementsIndirectCount(PrimitiveMode mode, DataType type, const std::vector<DrawElementsIndirectCommand> & indirect, int drawcount, std::size_t maxdrawcount, std::size_t stride);
				...
				static inline void copyImageSubData(Handle srcName, TextureTarget srcTarget, int srcLevel, int srcX, int srcY, int srcZ, Handle dstName, TextureTarget dstTarget, int dstLevel, int dstX, int dstY, int dstZ, std::size_t srcWidth, std::size_t srcHeight, std::size_t srcDepth);
				...
				static inline auto getDebugMessageLog(std::size_t count) -> std::vector<DebugMessage>;
				...
				static inline void bindBuffersRange(IndexedBufferTarget target, Handle first, std::size_t count, const std::vector<Handle> & buffers, const std::vector<int> & offsets, const std::vector<int> & sizes);
				...
				template <class T> static inline void clearTexSubImage(Handle texture, int level, int xoffset, int yoffset, int zoffset, std::size_t width, std::size_t height, std::size_t depth, PixelFormat format, DataType type, const std::vector<T> & data);
				...
				static inline void bindVertexBuffers(Handle first, std::size_t count, const std::vector<Handle> & buffers, const std::vector<int> & offsets, const std::vector<int> & sizes);
				...
				static inline void namedBufferData(Handle buffer, std::size_t size, const void * data, BufferUsage usage);
				static inline void namedBufferSubData(Handle buffer, int offset, std::size_t size, const void * data);
				static inline auto mapNamedBufferRange(Handle buffer, int offset, std::size_t length, MapBufferRangeAccessFlag access) -> void *;
				static inline auto mapNamedBuffer(Handle buffer, MapBufferRangeAccessFlag access) -> void *;
				static inline void flushMappedNamedBufferRange(Handle buffer, int offset, std::size_t length);
				static inline auto unmapNamedBuffer(Handle buffer) -> bool;
				static inline void copyNamedBufferSubData(Handle readBuffer, Handle writeBuffer, int readOffset, int writeOffset, std::size_t size);
				...
				static inline auto getNamedBufferSubData(Handle buffer, int offset, std::size_t size) -> void *;
				static inline auto getNamedBufferPointer(Handle buffer) -> void *;
				template <class T> static inline auto getnUniform([[maybe_unused]] Handle program, [[maybe_unused]] int location, [[maybe_unused]] std::size_t bufSize) -> std::vector<T>;
				template <> inline auto getnUniform<float>(Handle program, int location, std::size_t bufSize) -> std::vector<float>;
				template <> inline auto getnUniform<int>(Handle program, int location, std::size_t bufSize) -> std::vector<int>;
				template <> inline auto getnUniform<unsigned int>(Handle program, int location, std::size_t bufSize) -> std::vector<unsigned int>;
				template <> inline auto getnUniform<double>(Handle program, int location, std::size_t bufSize) -> std::vector<double>;
				static inline void textureSubImage3D(Handle texture, int level, int xoffset, int yoffset, int zoffset, std::size_t  width, std::size_t  height, std::size_t depth, PixelFormat format, PixelDataType type, const void * pixels);
				static inline void textureSubImage2D(Handle texture, int level, int xoffset, int yoffset, std::size_t width, std::size_t height, PixelFormat format, PixelDataType type, const void *pixels);
				static inline void textureSubImage1D(Handle texture, int level, int xoffset, std::size_t width, PixelFormat format, PixelDataType type, const void *pixels);
				static inline void copyTextureSubImage3D(Handle texture, int level, int xoffset, int yoffset, int zoffset, int x, int y, std::size_t width, std::size_t height);
				static inline void copyTextureSubImage2D(Handle texture, int level, int xoffset, int yoffset, int x, int y, std::size_t width, std::size_t height);
				static inline void copyTextureSubImage1D(Handle texture, int level, int xoffset, int x, int y, std::size_t width);
				static inline void compressedTextureSubImage3D(Handle texture, int level, int xoffset, int yoffset, int zoffset, std::size_t width, std::size_t height, std::size_t depth, PixelFormat format, std::size_t imageSize, const void * data);
				static inline void compressedTextureSubImage2D(Handle texture, int level, int xoffset, int yoffset, std::size_t width, std::size_t height, PixelFormat format, std::size_t imageSize, const void *data);
				static inline void compressedTextureSubImage1D(Handle texture, int level, int xoffset, std::size_t width, PixelFormat format, std::size_t imageSize, const void *data);
				...
				static inline auto getnTexImage(TextureTarget target, int level, PixelFormat format, DataType type, std::size_t bufSize) -> void *;
				static inline auto getTextureImage(Handle texture, int level, PixelFormat format, DataType type, std::size_t bufSize) -> void *;
				static inline auto getnCompressedTexImage(TextureTarget target, int level, std::size_t bufSize) -> void *;
				...
				static inline void namedRenderbufferStorageMultisample(Handle renderbuffer, std::size_t samples, PixelInternalFormat internalformat, std::size_t width, std::size_t height);
				static inline void namedRenderbufferStorage(Handle renderbuffer, PixelInternalFormat internalformat, std::size_t width, std::size_t height);
				...
				static inline auto createBuffers(std::size_t n) -> std::vector<Handle>;
				...
				static inline auto createProgramPipelines(std::size_t n) -> std::vector<Handle>;
				...
				static inline auto createTextures(TextureTarget target, std::size_t n) -> std::vector<Handle>;
				static inline auto createSamplers(std::size_t n) -> std::vector<Handle>;
				static inline void textureBufferRange(Handle texture, PixelInternalFormat internalFormat, Handle buffer, int offset, std::size_t size);
				static inline auto getTextureSubImage(Handle texture, int level, int xoffset, int yoffset, int zoffset, std::size_t width, std::size_t height, std::size_t depth, PixelFormat format, DataType type, std::size_t bufSize) -> void *;
				static inline auto getCompressedTextureSubImage(Handle texture, int level, int xoffset, int yoffset, int zoffset, std::size_t width, std::size_t height, std::size_t depth, std::size_t bufSize) -> void *;
				static inline void textureStorage1D(Handle texture, std::size_t levels, PixelInternalFormat internalformat, std::size_t width);
				static inline void textureStorage2D(Handle texture, std::size_t levels, PixelInternalFormat internalformat, std::size_t width, std::size_t height);
				static inline void textureStorage3D(Handle texture, std::size_t levels, PixelInternalFormat internalformat, std::size_t width, std::size_t height, std::size_t depth);
				static inline void textureStorage2DMultisample(Handle texture, std::size_t samples, PixelInternalFormat internalformat, std::size_t width, std::size_t height, bool fixedsamplelocations);
				static inline void textureStorage3DMultisample(Handle texture, std::size_t samples, PixelInternalFormat internalformat, std::size_t width, std::size_t height, std::size_t depth, bool fixedsamplelocations);
				static inline auto createFramebuffers(std::size_t n) -> std::vector<Handle>;
				...
				static inline auto createRenderbuffers(std::size_t n) -> std::vector<Handle>;
				static inline void textureBarrier();
				static inline auto createVertexArrays(std::size_t n) -> std::vector<Handle>;
				...
				static inline void vertexArrayVertexBuffer(Handle vaobj, Handle bindingindex, Handle buffer, int offset, std::size_t stride);
				static inline void vertexArrayVertexBuffers(Handle vaobj, Handle first, std::size_t count, const std::vector<Handle> & buffers, const std::vector<int> & offsets, const std::vector<int> & sizes);
				...
				static inline auto createTransformFeedbacks(std::size_t n) -> std::vector<Handle>;
				static inline void transformFeedbackBufferRange(Handle xfb, Handle index, Handle buffer, int offset, std::size_t size);
