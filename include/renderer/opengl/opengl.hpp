...
//		static inline void uniform1f(int location, float v0);
//		static inline void uniform2f(int location, float v0, float v1);
//		static inline void uniform3f(int location, float v0, float v1, float v2);
//		static inline void uniform4f(int location, float v0, float v1, float v2, float v3);
//		static inline void uniform1i(int location, int v0);
//		static inline void uniform2i(int location, int v0, int v1);
//		static inline void uniform3i(int location, int v0, int v1, int v2);
//		static inline void uniform4i(int location, int v0, int v1, int v2, int v3);
//		static inline void uniform1ui(int location, unsigned int v0);
//		static inline void uniform2ui(int location, unsigned int v0, unsigned int v1);
//		static inline void uniform3ui(int location, unsigned int v0, unsigned int v1, unsigned int v2);
//		static inline void uniform4ui(int location, unsigned int v0, unsigned int v1, unsigned int v2, unsigned int v3);
...
//		static inline void texImage2D(GLenum target, int level, int internalFormat, GLsizei width, GLsizei height, int border, GLenum format, GLenum type, const void * data);
