	...
	namespace renderer
	{
		...
		namespace opengl
		{
			...
			namespace OpenGL
			{
				...
				template <class T> static inline auto getBufferPointerv(BufferType target) -> T *;
				...
				static inline auto getQueryiv(QueryObjectType target, QueryObjectTypeParameter pname) -> std::vector<int>;
				static inline auto getQueryObjectiv(Handle id, QueryObjectTypeName pname) -> int;
				static inline auto getQueryObjectuiv(Handle id, QueryObjectTypeName pname) -> unsigned int;
				static inline auto getQueryObjecti64v(Handle id, QueryObjectTypeName pname) -> int64_t;
				static inline auto getQueryObjectui64v(Handle id, QueryObjectTypeName pname) -> uint64_t;
				...
				static inline auto getActiveUniformBlockiv(Handle program, unsigned int uniformBlockIndex, UniformBlockParameter pname) -> int;
				...
				static inline auto getActiveUniformsiv(Handle program, const std::vector<unsigned int> & uniformIndices, UniformDataType pname) -> std::vector<int>;
