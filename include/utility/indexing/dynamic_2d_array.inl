...
namespace ece
{
	namespace utility
	{
		namespace indexing
		{
			...
			template <class E>
			inline auto Dynamic2DArray<E>::operator[](const ece::size_t index) { return this->_buffer + (index * this->_width); }

			template <class E>
			inline auto Dynamic2DArray<E>::operator[](const ece::size_t index) const { return this->_buffer + (index * this->_width); }
			...
			template<class E>
			void Dynamic2DArray<E>::resize(const ece::size_t width, const ece::size_t height)
			{
