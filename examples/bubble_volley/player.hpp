...
public:
	...
	/**
	 * @fn constexpr Player() noexcept
	 * @brief Default constructor.
	 * @throw noexcept
	 */
	Player(ece::World & world, ID id) noexcept;

	/**
	 * @fn Player(const Player & copy) noexcept
	 * @param[in] copy The Player to copy from.
	 * @brief Default copy constructor.
	 * @throw noexcept
	 */
	Player(const Player & copy) noexcept = default;

	/**
	 * @fn Player(Player && move) noexcept
	 * @param[in] move The Player to move.
	 * @brief Default move constructor.
	 * @throw noexcept
	 */
	Player(Player && move) noexcept = default;
	...
	/**
	 * @fn Player & operator=(const Player & copy) noexcept
	 * @param[in] copy The Player to copy from.
	 * @return The Player copied.
	 * @brief Default copy assignment operator.
	 * @throw noexcept
	 */
	Player & operator=(const Player & copy) noexcept = default;

	/**
	 * @fn Player & operator=(Player && move) noexcept
	 * @param[in] move The Player to move.
	 * @return The Player moved.
	 * @brief Default move assignment operator.
	 * @throw noexcept
	 */
	Player & operator=(Player && move) noexcept = default;

	void jump(bool diagonal);
	void moveToLeft(bool diagonal);
	void moveToRight(bool diagonal);
	void sneak(bool diagonal);
