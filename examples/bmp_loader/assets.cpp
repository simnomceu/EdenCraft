...
void Assets::loadAssets()
{
	...
	assertAnyExceptionThrown(Assets::loadTexture("b-badrle4bis", "../../examples/bmp_loader/assets/b/badrle4bis.bmp"));
	assertAnyExceptionThrown(Assets::loadTexture("b-badrle4ter", "../../examples/bmp_loader/assets/b/badrle4ter.bmp"));
	assertAnyExceptionThrown(Assets::loadTexture("b-badrlebis", "../../examples/bmp_loader/assets/b/badrlebis.bmp"));
	...
	assertAnyExceptionThrown(Assets::loadTexture("q-pal8os2v2-16", "../../examples/bmp_loader/assets/q/pal8os2v2-16.bmp"));
	...
	assertAnyExceptionThrown(Assets::loadTexture("q-pal8rlecut", "../../examples/bmp_loader/assets/q/pal8rlecut.bmp"));
	assertAnyExceptionThrown(Assets::loadTexture("q-pal8rletrns", "../../examples/bmp_loader/assets/q/pal8rletrns.bmp"));
	assertAnyExceptionThrown(Assets::loadTexture("q-rgb16-231", "../../examples/bmp_loader/assets/q/rgb16-231.bmp"));
	assertAnyExceptionThrown(Assets::loadTexture("q-rgb16-3103", "../../examples/bmp_loader/assets/q/rgb16-3103.bmp"));
	assertAnyExceptionThrown(Assets::loadTexture("q-rgb16faketrns", "../../examples/bmp_loader/assets/q/rgb16faketrns.bmp"));
	assertAnyExceptionThrown(Assets::loadTexture("q-rgb24jpeg", "../../examples/bmp_loader/assets/q/rgb24jpeg.bmp"));
	assertAnyExceptionThrown(Assets::loadTexture("q-rgb24largepal", "../../examples/bmp_loader/assets/q/rgb24largepal.bmp"));
	assertAnyExceptionThrown(Assets::loadTexture("q-rgb24lprof", "../../examples/bmp_loader/assets/q/rgb24lprof.bmp"));
	assertAnyExceptionThrown(Assets::loadTexture("q-rgb24png", "../../examples/bmp_loader/assets/q/rgb24png.bmp"));
	assertAnyExceptionThrown(Assets::loadTexture("q-rgb24prof", "../../examples/bmp_loader/assets/q/rgb24prof.bmp"));
	assertAnyExceptionThrown(Assets::loadTexture("q-rgb24prof2", "../../examples/bmp_loader/assets/q/rgb24prof2.bmp"));
	assertAnyExceptionThrown(Assets::loadTexture("q-rgb32-7187", "../../examples/bmp_loader/assets/q/rgb32-7187.bmp"));
	assertAnyExceptionThrown(Assets::loadTexture("q-rgb32-111110", "../../examples/bmp_loader/assets/q/rgb32-111110.bmp"));
	assertNoExceptionThrown(Assets::loadTexture("q-rgb32fakealpha", "../../examples/bmp_loader/assets/q/rgb32fakealpha.bmp"));
	assertAnyExceptionThrown(Assets::loadTexture("q-rgb32h52", "../../examples/bmp_loader/assets/q/rgb32h52.bmp"));
	assertAnyExceptionThrown(Assets::loadTexture("q-rgb32-xbgr", "../../examples/bmp_loader/assets/q/rgb32-xbgr.bmp"));
	assertAnyExceptionThrown(Assets::loadTexture("q-rgba16-1924", "../../examples/bmp_loader/assets/q/rgba16-1924.bmp"));
	assertAnyExceptionThrown(Assets::loadTexture("q-rgba16-4444", "../../examples/bmp_loader/assets/q/rgba16-4444.bmp"));
	assertAnyExceptionThrown(Assets::loadTexture("q-rgba16-5551", "../../examples/bmp_loader/assets/q/rgba16-5551.bmp"));
	assertAnyExceptionThrown(Assets::loadTexture("q-rgba32", "../../examples/bmp_loader/assets/q/rgba32.bmp"));
	assertAnyExceptionThrown(Assets::loadTexture("q-rgba32-61754", "../../examples/bmp_loader/assets/q/rgba32-61754.bmp"));
	assertAnyExceptionThrown(Assets::loadTexture("q-rgba32-81284", "../../examples/bmp_loader/assets/q/rgba32-81284.bmp"));
	assertAnyExceptionThrown(Assets::loadTexture("q-rgba32-1010102", "../../examples/bmp_loader/assets/q/rgba32-1010102.bmp"));
	assertAnyExceptionThrown(Assets::loadTexture("q-rgba32abf", "../../examples/bmp_loader/assets/q/rgba32abf.bmp"));
	assertAnyExceptionThrown(Assets::loadTexture("q-rgba32h56", "../../examples/bmp_loader/assets/q/rgba32h56.bmp"));
	...
	assertAnyExceptionThrown(Assets::loadTexture("g-rgb24pal", "../../examples/bmp_loader/assets/g/rgb24pal.bmp"));
	assertNoExceptionThrown(Assets::loadTexture("g-rgb32", "../../examples/bmp_loader/assets/g/rgb32.bmp"));
	assertAnyExceptionThrown(Assets::loadTexture("g-rgb32bf", "../../examples/bmp_loader/assets/g/rgb32bf.bmp"));
	assertAnyExceptionThrown(Assets::loadTexture("g-rgb32bfdef", "../../examples/bmp_loader/assets/g/rgb32bfdef.bmp"));
}