...
namespace ece
{
	...
	void OpenGL::checkErrors_(const char * file, const int line, const char * function)
	{
	...
	void APIENTRY OpenGL::glDebugOutput(GLenum source, GLenum type, GLuint id, GLenum severity, GLsizei length, const GLchar *message, const void *userParam)
	{
